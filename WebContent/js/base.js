...
//		alert(1);
		if ($(this).hasClass('checked')) {
			...
			if($('.protocol .checkbox').hasClass('checked')){
				...
				var myurl='ShopitemToOrdersAndDetailController.do?recipientsIdCheck='+$('.address .checked').attr("id")+"&sumPrice="+$("#sumPrice").text();
//				alert(myurl);
				$('.submit a').attr("href",myurl );
			}
		}
	});
...
//		alert(1);
		if ($(this).hasClass('checked')) {
			...
			if($('.address .checkbox').hasClass('checked')){
				$('.submit a').css('background', 'rgb(211, 32, 89)');
				var myurl='ShopitemToOrdersAndDetailController.do?recipientsIdCheck='+$('.address .checked').attr("id")+"&sumPrice="+$("#sumPrice").text();
//				alert(myurl);
				$('.submit a').attr("href",myurl );
