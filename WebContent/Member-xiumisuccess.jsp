...
<head>
	<meta charset="UTF-8">
	<title>修改成功-修改密码-个人信息-会员中心-澳猫团</title>
		...
		<div class="head center_1200">
			...
			<div class="headRight">
				<ul>
					...
					<li class="erWrap">
						<strong></strong>
						<a href="Member-xiumi.jsp">个人中心</a>
						<em></em>
						<p class="headEr">
							<a href="#">我的优惠券</a>
							<a href="#">账户安全</a>
				...
				<div class="MeRightArea">
					...
					<div class="informationArea">
						...
						<div class="InforContent">
							...
							<div class="finishedModify">
								<p>
									<img src="images/ture.png" alt="">
									<span>恭喜你，修改密码成功</span>
								</p>
								<p>
									<a class="kefu" href="">联系客服</a>
									<a class="goShopping" href="index.jsp">继续购物&gt;Go</a>
								</p>
							</div>
						</div>
					</div>
