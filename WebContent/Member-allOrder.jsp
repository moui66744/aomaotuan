...
<body>
	...
	<div class="MeSubNavW">
		<ul class="MeSubNav clearfix textWarp w1190">
			...
			<li>&gt;</li>
			<li><a target="_blank" href="OrderController">我的订单</a></li>
		</ul>
	</div>
	<!-- 主要内容 -->
	<div class="MeMainW">
				...
				<div class="MeLeftNav">
					...
					<div class="MeTitle">
						...
						<dl class="MeInformation">
							<dt><em>个人信息</em></dt>
							<dd><em><i>·</i><a href ="Member-xiumi.html">修改密码</a></em></dd> 
				...
				<div class="MeRightArea">
					...
					<div class="personArea">
						...
						<div class="MeorderArea ">
							<!-- 我的订单的上面导航 -->
							<ol class="persontab">  
								<li class=" current"><a href="OrderController">全部订单</a></li>
								<li><a href="OrderS2Controller">待付款</a></li>
								<li><a href="OrderS1Controller">海关清关</a></li>
								<li><a href="OrderS3Controller">待发货</a></li>
								<li><a href="OrderS4Controller">待收货</a></li>
								<li><a href="OrderS5Controller">待评论</a></li>
							...
							<div class="MeOrder">
								<!-- 报关中 -->
								<c:forEach items="${ordersType}" var="order">
									...
									<div class="ListArea">
										<ul class="ListTable">
											<li class="one clearfix">
												<a href="">
													<div class="pruPic"><img src="${pageContext.request.contextPath}/uploadimg/${order.orderDetail.goods.goodsImg}" alt=""></div>
													<div class="pruTitle">
														${order.orderDetail.goods.goodsName}
													</div>
												</a>
												<div class="pruNum">×<i>${order.orderDetail.detailNum}</i></div>
											</li>
											<li class="two">${order.orderName}</li>
											<li class="three">
												<p>总额￥${order.orderPrice}</p>
												<p>在线支付</p>
												<p>含税/运费：￥0.00</p>
											</li>
											<li class="four">
												<p class="ing">${order.orderForStatus.orderStatusName}</p>
												<p><a href="">订单详情</a></p>
											</li>
											<li class="five">
