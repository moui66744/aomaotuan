...
<head>
	<meta charset="UTF-8">
	<title>修改密码-个人信息-会员中心-澳猫团</title>
				...
				<div class="MeRightArea">
					...
					<div class="informationArea">
						...
						<div class="InforContent">
							<p class="InTitle">你正在为（${users.userEmail}）修改密码，请选择身份验证方式：</p>
							<ol class="inforFunction">
								<li class="IFList clearfix">
									<div class="IFiconPhone"></div>
									<p>
										<em>通过“手机验证码”</em>
										<span>如果你的手机还在正常使用，请选择此方式</span>
									</p>
								<A href="Member-xiumiphone.jsp">
									<button>立即验证</button>
								</A>
								</li>
								<li class="IFList clearfix">
									<div class="IFiconEmail"></div>
									<p>
										<em>通过“邮件验证”</em>
										<span>如果你接受邮件比较方便，请选择此方式</span>
									</p>
									<A href="Member-xiumiemail.jsp">
    									<button>立即验证</button>
									</A>
								</li>
							</ol>
