...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<title>手机-修改密码-个人信息-会员中心-澳猫团</title>
	...
	<div class="MeMainW">
		<div class="MeMain  w1190">
			<div class="MeArea clearfix">
				...
				<!-- 右边主要内容 -->
				<input id="phoneNum" type="hidden" value="${users.userPhone}"/>
<!--  -->
...
$(function(){
	$("#btn").click(function(){	
		if($("#userPhone").val()){
			if(phoneFun($("#userPhone").val())){
				if ($("#userPhone").val() == $("#phoneNum").val()) {
					$.ajax({
						type:"post",
					...
					alert("您输入的手机号不是本人的手机号，请重新输入。");
				}
			} else{
				alert("手机号格式不正确，请注意检查。");
			}
			...
			if ($("#userPhone").val()) {
				...
				<div class="MeRightArea">
					...
					<div class="informationArea">
						...
						<div class="inforArea">
							<h5>您正在使用<em>手机验证码</em>验证身份，请完成以下操作</h5>							
							<div id="register">
								<form class="form-horizontal" id="RegistForm" method="post"
									action="UserPhoneJudgeController.do">
<!-- 									<fieldset>
										<div class="inforMail"><span>您的手机号：</span>
											<div class="col-sm-5">
												<input type="userPhone" placeholder="请填写手机号..." class="form-control"
											...
											<div class="inforYzm">
															  <span>您的验证码</span>
											<div class="inforGet">
												<input type="text" name="verifyCode" id="verifyCode" placeholder="请输入手机的验证码"
													class="form-control" required> 
													<input type="button" name="btn"
													class="btn btn-default" id="btn" value="发送验证码" />
											</div>
											<div class="inforSubmit">
												<a href="login.jsp" class="btn btn-success"></a> <input
													class="btn btn-info" type="submit" id="submit" value="确定" />
											</div>
											
												<div class="inforText">
													<h6>没收到手机验证码？</h6>
													<p>
														1、网络通讯异常可能造成手机验证码丢失，请重新获取或稍后再试
													</p>
													<p>
														2、请核实手机号是否正常使用
													</p>
													<p>
														3、如果手机号已停用，请选择其他验证方式
													</p>
												</div>
										</div>
									</fieldset> -->
									<fieldset>
										<div class="inforMail" >
											...
											<!-- <div class="col-sm-5"> -->
												<input type="text" placeholder="请填写手机号..." class="form-control"
													id="userPhone" name="userPhone" required>
												<!-- <input type="hidden" id="realemail" name="realemail"> -->
											<!-- </div> -->
										</div>
										<div class="inforGet">
												<!-- <input type="button" name="btn"
												class="btn btn-default" id="btn" value="发送验证码" /> -->
												<input type="button" id="btn" value="发送验证码" style="
										    width: 130px;
										    height: 34px;
										    background: #F0F0F0;
										    color: #999999;
										...
										<div class="inforYzm">
											<span>您的验证码</span>
											<input type="text" name="verifyCode" id="verifyCode" placeholder="请输入手机验证码"
