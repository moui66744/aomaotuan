...
<!-- 订单部分 -->
<%-- <form action="${pageContext.request.contextPath }/ShopitemsToOrdersController.do" > --%>
...
<div class="indent boxS">
	...
	<!-- 全选标题部分 -->
		<div class="IAhead">
			...
			<<!-- input type="checkbox"  class="Allcheck checkbox" > -->
			<span>全选</span>
		...
		<div class="IAbd">
			...
			<c:forEach items="${allShopitemsAndGoods }" var="shopitems" varStatus="status">
				<li class="IAbdw">
					 <span class="lincheck checkbox" id="${shopitems.itemId}"></span> 
					<%-- <input type="checkbox"   name="goodsId" value="${shopitems.itemGoods}"> --%>
					<!-- <span class="lincheck checkbox"></span> -->
					<img src="images/${shopitems.goods.goodsImg} " alt="">
					<p>
						<a class="pro" href="#">${shopitems.goods.goodsName}</a>
						<a class="use" href="#">
							适用税率：10%
							<s></s>
							<u>
					...
					<ul class="IAul">
						...
						<li class="price">
							<strong>¥ <u>${shopitems.goods.goodsPrice}</u></strong><br>
							<s>${shopitems.goods.goodsPrice+20}</s>
						</li>
						<li class="num">
							<span class="reduce">-</span>
							<input type="text" value="${shopitems.itemNum}" id="num${shopitems.itemId}">
							<span class="add">+</span>
						</li>
						<li class="Lastprice">¥ <u>${shopitems.goods.goodsPrice * shopitems.itemNum}</u></li>
						<li class="last btn">
							<button>移入收藏夹</button><br>
							<!-- <button class="delet">删除</button> -->
							<A class="delet" href="${pageContext.request.contextPath }/DeleteShopitemsController.do?itemId=${shopitems.itemId}">删除</A>
						</li>
					</ul>
				</li>
			...
			<div class="account">
				<ul>
					...
					<li class="mprice" >￥<u class="allguanshui">11.4</u></li>
				</ul>
			</div>
			<div class="IAbdfoot">
				...
				<!-- <a href="#"></a> -->
				<!-- <input id="jiesuan" type="image" src="images/jiesuan.jpg"  style="float:right" width="130"> -->
				<a href="javascript:void(0);" id="jiesuan">去结算</a>
				<p>
					<strong>已选商品<b id="allnum"> 1 </b>件</strong>
					<strong>总价（不含运费）：<b>￥<u class="allpri">114.00</u></b></strong><br>
					<em>活动优惠 ：-￥<u>0.00</u></em>
					<em>商品应付总计 ：￥<u  class="allpri" id="mysumprice">114.00</u></em>
					<em>订单关税：￥<u >0</u></em>
				</p>
			</div>
...
<script src="js/zhqAjaxCheck2.js"></script>
</body>
</html>