	...
	<div class="head w1190">
		...
		<div class="headRight">
			<ul>
				...
				<li><a href="Member-allOrder.html">我的订单</a></li><span>|</span>
				<li class="erWrap">
					<strong></strong>
					<a href="#">个人中心</a>
					<em></em>
...
<div class="OrderInfow w1190 boxS">
	<div class="OrderInfo">
		<div class="OrderInArea">
			<p class="one"><em></em><span>订单提交成功，现在只差最后一步啦</span></p>
			<p class="two">请您在提交订单后<b>1小时59分</b>后完成支付，否则订单会自动取消！</p>
		</div>
		<div class="OrderInAreadown">
			<p class="left">
				<c:forEach items="${orderDetailList }" var="orderDetail" >
				<span>
					商品名称：${orderDetail.goods.goodsName} ， 商品数量：${orderDetail.detailNum} ，商品价格： ${orderDetail.detailPrice}
					<!-- Blackmores EPo 月见草    750克      保税区直发        新郑保税仓发货  -->
				</span>
				</c:forEach>
				 <span class="c99">
				    收货信息 ：收货地址：${recipients.recipientsAddress} ，收货人姓名： ${recipients.recipientsName} ，手机：${recipients.recipientsPhone} 
				 	<!-- 收货信息 : 河南省，郑州市，高新区，紫薇小区，马云，手机：155****6627 -->
				 </span>
			</p>
			<a href="#" class="right">
				我的订单 &gt;
	...
	<div class="way">
		<h3>
			...
			<span>
				...
				<u>
					<b></b>
					购买境外商品需要提供实名认证信息，如您的支付方式没有实名认证，则您在支付时可能会被要求进行实名验证
				</u>
			</span>
		</h3>
		<div class="wayArea">
			...
			<a href="alipay.trade.page.pay.jsp?sumPrice=${sumPrice}">用支付宝支付</a>
		</div>
	</div>
</div>
<!-- 底部 -->
