 ...
 */
@WebServlet("/InsertOrderRecipientsController.do")
public class InsertOrderRecipientsController extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		orderRecipients.setRecipientsUser(recipientsUser);
